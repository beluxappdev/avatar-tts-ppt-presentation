...
if __name__ == "__main__":
    ...
    # # Example 2: Using the class step by step
    # with VideoTransformer() as transformer:
    #     transformer.load_avatar_video("meg.webm")
    #     transformer.load_background("background.png")
    #     transformer.crop_to_aspect_ratio(9/16)
    #     transformer.resize_avatar("large")
    #     transformer.position_avatar(("center", "bottom"))
    #     transformer.compose_video()
    #     transformer.save_video("output2.mp4")
    
    # # Example 3: Using pixel-based positioning
    # with VideoTransformer() as transformer:
    #     transformer.load_avatar_video("meg.webm")
    #     transformer.load_background("background.png")
    #     transformer.resize_avatar(0.75)  # Custom multiplier
    #     transformer.position_avatar((100, 50))  # Pixel coordinates
    #     transformer.compose_video()
    #     transformer.save_video("output3.mp4")